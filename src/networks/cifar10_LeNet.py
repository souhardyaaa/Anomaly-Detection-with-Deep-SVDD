...
class CIFAR10_LeNet(BaseNet):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, 3, bias=False, padding=1)
...
class CIFAR10_LeNet_Autoencoder(BaseNet):
    ...
    def __init__(self):
        ...
        # Decoder
        self.deconv1 = nn.ConvTranspose2d(int(self.rep_dim / (4 * 4)), 128, 3, bias=False, padding=1)
        ...
        self.deconv4 = nn.ConvTranspose2d(32, 3, 3, bias=False, padding=1)
